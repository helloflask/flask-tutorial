...
After working through this book, you should be ready to build a simple web application on your own. Here is a challenge: add a guestbook to Watchlist, similar to [SayHello](http://sayhello.helloflask.com).
